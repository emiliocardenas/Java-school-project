...
public class WordCensus_TestCasesSubsetForStudents_1_ENVIRONMENT
{
	...
	public void validLastNameStructureTest()
	{
		...
		int i = 2;
		while(i < lastName.length() && Character.isLowerCase(lastName.charAt(i))) i++;
		if(i < lastName.length() && Character.isUpperCase(lastName.charAt(i))) i++;
		while(i < lastName.length() && Character.isLowerCase(lastName.charAt(i))) i++;
	...
	public void lastNameTest()
	{
		...
		String actualClassName = getClassNameWithoutPackage(WordCensusImpl_Cardenas.class);
	...
	protected Class<? extends WordCensus> getStudentClass()
	{
		...
		return WordCensusImpl_Cardenas.class;
	}
